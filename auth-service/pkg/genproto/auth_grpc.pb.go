...
type AuthServiceClient interface {
	GetUserEmail(ctx context.Context, in *UserEmailRequest, opts ...grpc.CallOption) (*UserEmailResponse, error)
}
...
func (c *authServiceClient) GetUserEmail(ctx context.Context, in *UserEmailRequest, opts ...grpc.CallOption) (*UserEmailResponse, error) {
...
type AuthServiceServer interface {
	GetUserEmail(context.Context, *UserEmailRequest) (*UserEmailResponse, error)
...
func (UnimplementedAuthServiceServer) GetUserEmail(context.Context, *UserEmailRequest) (*UserEmailResponse, error) {
...
func _AuthService_GetUserEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetUserEmail(ctx, req.(*UserEmailRequest))
	}
